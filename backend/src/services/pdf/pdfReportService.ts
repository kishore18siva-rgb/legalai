...
export class PdfReportService {
  ...
  public async generateComplianceReport(inspectionData: any, outputPath: string): Promise<string> {
    ...
    page.drawText('STATUTORY LEGAL DISCLAIMER & DATA ORIGIN:', { x: 40, y: 62, size: 8, font: fontBold, color: rgb(0.4, 0.4, 0.4) });
    page.drawText('Product information was manually entered and confirmed by the inspecting officer. Assessment uses captured package images as evidence.', { x: 40, y: 50, size: 7, font, color: rgb(0.4, 0.4, 0.4) });
    page.drawText('This assessment is an automated compliance-assistance result and final enforcement remains with the competent authority.', { x: 40, y: 38, size: 7, font, color: rgb(0.4, 0.4, 0.4) });
