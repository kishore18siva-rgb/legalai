...
class PdfReportService {
     ...
     */
    async generateComplianceReport(inspectionData, outputPath) {
        ...
        page.drawRectangle({
            ...
            width,
            height: 70,
            color: (0, pdf_lib_1.rgb)(0.04, 0.16, 0.26),
        });
        ...
        page.drawText('The Legal Metrology (Packaged Commodities) Rules, 2011 Audit', {
            ...
            size: 10,
            font,
            color: (0, pdf_lib_1.rgb)(0.8, 0.88, 0.95),
        });
        y = height - 90;
        // Meta Details Box
        page.drawRectangle({
            ...
            width: width - 60,
            height: 75,
            color: (0, pdf_lib_1.rgb)(0.95, 0.97, 0.99),
            borderColor: (0, pdf_lib_1.rgb)(0.8, 0.85, 0.9),
            borderWidth: 1,
        });
        ...
        page.drawText(`Overall Compliance Score: ${inspectionData.complianceScore.toFixed(1)}% (${inspectionData.overallResult})`, { x: 45, y: y - 60, size: 10, font: fontBold, color: inspectionData.overallResult === 'PASS' ? (0, pdf_lib_1.rgb)(0.1, 0.6, 0.2) : (0, pdf_lib_1.rgb)(0.8, 0.1, 0.1) });
        y -= 105;
        // Section Title
        page.drawText('RULE-BY-RULE COMPLIANCE EVALUATION', { x: 30, y, size: 12, font: fontBold, color: (0, pdf_lib_1.rgb)(0.04, 0.16, 0.26) });
        y -= 15;
        // Table Header
        page.drawRectangle({ x: 30, y: y - 20, width: width - 60, height: 20, color: (0, pdf_lib_1.rgb)(0.9, 0.93, 0.96) });
        ...
        for (const r of ruleResults) {
            ...
            let statusColor = (0, pdf_lib_1.rgb)(0.2, 0.6, 0.2); // PASS green
            if (r.result === 'FAIL')
                statusColor = (0, pdf_lib_1.rgb)(0.8, 0.1, 0.1);
            if (r.result === 'REVIEW')
                statusColor = (0, pdf_lib_1.rgb)(0.8, 0.4, 0.0);
            if (r.result === 'NOT_APPLICABLE')
                statusColor = (0, pdf_lib_1.rgb)(0.4, 0.5, 0.6);
